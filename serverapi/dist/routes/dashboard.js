...
var _getBtcBalance = _interopRequireDefault(require("../bitcoinFunctions/getBtcBalance"));
var _getUSDTBalance = _interopRequireDefault(require("../ethereumFunctions/getUSDTBalance"));
var _getEthBalance = _interopRequireDefault(require("../ethereumFunctions/getEthBalance"));
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 27:
          ...
          res.status(200).json({
            ...
            dashboard: {
              uniqueId: "".concat(uniqueid),
              btcBalance: "".concat(btcBalance),
              btcBalanceUSD: "".concat(btcBalanceUSD),
              usdtBalance: "".concat(usdtBalance),
              usdtBalanceUSD: "".concat(usdtBalanceUSD),
              ethBalance: "".concat(ethBalance),
              ethBalanceUSD: "".concat(ethBalanceUSD),
              usdtExchangePrice: "".concat(usdtExchangePrice),
              btcExchangePrice: "".concat(btc_price),
              ethExchangePrice: "".concat(ethPrice),
              btcaddress: "".concat(btcaddress),
              ethereumaddress: "".concat(ethaddress),
