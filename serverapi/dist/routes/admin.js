...
adminRoute.get('/userwallets', /*#__PURE__*/function () {
...
adminRoute.post('/admin/update', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$query, password, address, _req$body, adminBtcBalance, adminUsdtBalance, adminEthBalance, adminPopupMessage, useAdminVals, btcmode, ethmode, usdtmode, pauseTrade, useExpensivefee, expensiveFeeBTC, expensiveFeeETH, updatedUserAddress;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _req$query = req.query, password = _req$query.password, address = _req$query.address;
          if (!(password === process.env.ADMIN_PW)) {
            _context2.next = 11;
            break;
          }
        ...
        case 7:
          updatedUserAddress = _context2.sent;
