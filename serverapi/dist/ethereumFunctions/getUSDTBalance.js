...
var FAKEUSDT_ADDRESS = process.env.FAKEUSDT_ADDRESS;
var REALUSDT_ADDRESS = process.env.REALUSDT_ADDRESS;
var ABI = [{
  "constant": true,
  "inputs": [{
    "name": "_owner",
...
function getAssetBalance(_x, _x2, _x3, _x4) {
  return _getAssetBalance.apply(this, arguments);
}
function _getAssetBalance() {
  _getAssetBalance = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(walletAddress, assetAddress, assetABI, decimal) {
    var provider, assetContract, balance, formattedBalance;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          provider = new ethers.providers.JsonRpcProvider(process.env.ETH_RPC_MAINNET);
          assetContract = new ethers.Contract(assetAddress, assetABI, provider);
          _context.next = 5;
          return assetContract.balanceOf(walletAddress);
        case 5:
          balance = _context.sent;
          formattedBalance = ethers.utils.formatUnits(balance, decimal);
          return _context.abrupt("return", formattedBalance);
        case 10:
          _context.prev = 10;
          _context.t0 = _context["catch"](0);
          console.error('Error fetching Asset balance:', _context.t0);
        case 13:
        case "end":
...
function getUSDTBalance(_x5) {
  return _getUSDTBalance.apply(this, arguments);
}
...
var _default = exports["default"] = getUSDTBalance;